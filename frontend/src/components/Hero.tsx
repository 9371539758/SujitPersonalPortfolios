...
export const Hero: React.FC = () => {
      ...
      <div className="hero-text-container">
        ...
        <h1 className="line-designer" ref={designerRef}>
          ...
          <div className="mac-finder-icon">
            <svg viewBox="0 0 64 64" width="100%" height="100%">
              ...
              <path
                d="M 52 10 L 54 15 L 59 17 L 54 19 L 52 24 L 50 19 L 45 17 L 50 15 Z"
                fill="#ff9f1c"
              />
            </svg>
            <svg
        ...
        <div className="hero-sub-caption">
          <p className="hindi-title">
            ...
            , डिज़ाइन के माध्यम से बेहतर मानव अनुभव बनाने में शामिल॥
            <br />
            <br />
            जहां हर पिक्सेल कहानी कहता है, और हर इंटरफ़ेस
            <span style={{ color: "var(--accent-color)", fontWeight: "bold" }}>
              मानवीय भावनाओं
            </span>{" "}
            को छूता है।
  ...
  <div className="marquee-track">
    ...
    <div className="marquee-list">
      <div className="brand-logo" style={{ fontWeight: 700 }}>JavaScript</div>
      <div className="brand-logo" style={{ fontWeight: 700, color: '#61DAFB' }}>React</div>
      <div className="brand-logo" style={{ fontWeight: 700 }}>TypeScript</div>
      <div className="brand-logo" style={{ fontFamily: "monospace" }}>Node.js</div>
      <div className="brand-logo">Next.js</div>
      <div className="brand-logo" style={{ fontStyle: "italic" }}>Tailwind</div>
      <div className="brand-logo">System Design</div>
    </div>
    ...
    {/* Third list for smoother effect */}
    <div className="marquee-list">
      <div className="brand-logo" style={{ fontWeight: 700 }}>JavaScript</div>
      <div className="brand-logo" style={{ fontWeight: 700, color: '#61DAFB' }}>React</div>
      <div className="brand-logo" style={{ fontWeight: 700 }}>TypeScript</div>
